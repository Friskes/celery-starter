...
celery_app_not_found = 'The name of the celery app could not be found, pass the name manually as a positional parameter.'
...
if localization == 'ru_RU':
    ...
    celery_app_not_found = 'Не удалось найти название celery приложения, передайте название вручную, как позиционный параметр.'
